...
namespace SnowyPeak.DualityUI.Controls
{
	public class ProgressBar : Control
	{
        ...
        public ProgressConfiguration ProgressConfiguration { private get; set; }
        ...
        public override void ApplySkin(Skin skin)
        {
            ...
            if (this.ProgressConfiguration == ProgressConfiguration.DEFAULT)
            { this.ProgressConfiguration = skin.GetTemplate<ProgressTemplate>(this).ProgressConfiguration; }
        }
		...
		public override void Draw(Canvas canvas, float zOffset)
		{
			...
			if (this.ProgressConfiguration.Bar.IsAvailable)
			{
				Appearance appearance = this.ProgressConfiguration.Bar.Res;
				...
				if (tx != null)
				{
					...
					canvas.DrawVertices<VertexC1P3T2>(_barVertices, VertexMode.Quads);
				}
			}
		}
